        ...
        <div className="flex h-full max-h-full flex-grow flex-col items-center overflow-x-hidden font-noto-sans text-white ">
          <div className="mx-auto mb-20 mt-10 w-full px-4 md:w-[80%] md:max-w-5xl md:px-0">
            ...
            <p className="my-5">
              ...
              "Company"). By accessing or using Tokei's services, including but
              not limited to our streaming platform, website, and related
              services (collectively, the "Service"), you agree to be bound by
              these Terms of Service ("TOS"). By clicking "Sign Up," you
              acknowledge that you have read, understood, and agree to be bound
              by these Terms of Service. If you have any questions or require
              support, please contact us at support@tokei.live. Please read
            ...
            <p>
              The Service is intended for individuals aged 13 and above. By
